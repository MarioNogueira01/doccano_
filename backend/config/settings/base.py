...
if DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1:3000", "http://0.0.0.0:3000", "http://localhost:3000", "http://10.0.2.15:3000"]
...
# Add Channel Layers config (using in-memory for simplicity)
CHANNEL_LAYERS = {
    "default": {
